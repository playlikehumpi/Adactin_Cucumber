...
public class BaseClass 
{
	...
	public static WebDriver browserLaunch(String browser) {
		...
		if (browser.equalsIgnoreCase("CHROME")) {
			...
			System.setProperty("webdriver.chrome.driver", "F:\\Eclipse Workarea\\AdactinCucumber\\Driver\\chromedriver.exe");

			driver = new ChromeDriver();
		} else if (browser.equalsIgnoreCase("FIREFOX")) {

			System.setProperty("webdriver.gecko.driver", "F:\\Eclipse Workarea\\AdactinCucumber\\Driver\\chromedriver.exe");
